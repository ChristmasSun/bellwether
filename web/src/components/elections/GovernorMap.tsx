...
import { type GovernorRace } from "@/lib/electionData";
...
export function GovernorMap({ governorRaces, onStateClick }: Props) {
  const [hovered, setHovered] = useState<string | null>(null);
  const raceMap = Object.fromEntries(governorRaces.map((r) => [r.stateCode, r]));
